...
def calculate_speed_in_kmps(feature_distance, earth_GSD, time_difference, earth_radius, alt, alt_iss):
...
while time.time() - start_runtime < runtime:
    ...
    for (distance, alt) in pairs:
        speed_for_match = calculate_speed_in_kmps(distance, earth_GSD, time_difference, earth_radius, alt, alt_iss)
