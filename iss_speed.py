...
def display_matches(image_1_cv, keypoints_1, image_2_cv, keypoints_2, matches, matchesMask):
    draw_params = dict(matchColor = (0,255,0), singlePointColor = (255,0,0), matchesMask = matchesMask, flags = cv2.DrawMatchesFlags_DEFAULT)
    match_img = cv2.drawMatches(image_1_cv, keypoints_1, image_2_cv, keypoints_2, matches, None, **draw_params)
...
avg_speed_img = avg_speed = avg_time = 0
...
keypoints_1, descriptors_1, keypoints_2, descriptors_2 = calculate_features(image_1_cv, image_2_cv, 50000) # Get keypoints and descriptors
matches, matchesMask = calculate_matches(descriptors_1, descriptors_2) # Match descriptors
display_matches(image_1_cv, keypoints_1, image_2_cv, keypoints_2, matches, matchesMask) # Display matches

print(matches)

#coordinates_1, coordinates_2 = find_matching_coordinates(keypoints_1, keypoints_2, matches)
#average_feature_distance = calculate_mean_distance(coordinates_1, coordinates_2)
#speed_img = calculate_speed_in_kmps(average_feature_distance, GSD, time_difference)
...
avg_speed_img = avg_speed_img / (len(images) - 1)
avg_speed = avg_speed / (len(images) - 1)
